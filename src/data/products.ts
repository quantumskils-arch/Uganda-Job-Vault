...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 'UGX 15,000',
    priceUSD: '$4',
    selarLink: 'https://selar.com/356130m4k7',
    category: 'papers',
    badge: '🔥 NEW',
    coverImage: '/covers/absa-bank-pack.png',
    whatsInside: [
      '25 numerical reasoning — compound interest, cost-to-income ratio, trade finance',
      '15 verbal reasoning — Absa pan-African transformation & risk management passages',
      '15 situational judgement — assessment centre, mis-selling, phishing, media handling',
      '25 Absa knowledge questions — rebrand history, 4 values, AfCFTA, Graduate Programme',
      '30 interview Q&As — knowledge, STAR competency & closing answers',
      'SHL test tips + assessment centre strategy + thank-you email tip',
      'Application guide + background check warning + career path to Country Director',
    ],
  },
  {
    id: 'equity-bank-pack',
  ...
  {
    id: 'govt-jobs-bundle',
    title: 'Government Jobs Success Bundle 2026 — PSC + Interview + Civil Service',
    description: 'Everything to land a Uganda government job: PSC aptitude pack + Civil Service aptitude pack + Government Jobs interview guide. Save UGX 15,000.',
    price: 'UGX 36,000',
    priceUSD: '$10',
    selarLink: 'https://selar.com/131fjr611a',
    category: 'bundle',
    badge: 'Best Value',
    coverImage: '/covers/govt-jobs-bundle.png',
    whatsInside: [
      'PSC Aptitude Pack — 90 questions',
      'Civil Service Aptitude Pack — 80 questions',
      'Government Jobs Interview Guide',
      'Test prep, knowledge & interview in one',
      'Save UGX 15,000 vs buying separately',
    ],
  },
  {
    id: 'reasoning-drills',
